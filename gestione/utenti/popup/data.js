;(function() {
  ...
  function salva(e) {
    ...
    var giorno = document.getElementById('giornoNascita')
    var mese = document.getElementById('meseNascita')
    var anno = document.getElementById('annoNascita')
    var id = document.getElementById('idUtente')

    // Invio il token al server
    var xhr = new XMLHttpRequest()
    xhr.open('POST', '/ajax/utente/anagrafiche/dataNascita.php', true)
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded')
    xhr.send('id=' + encodeURIComponent(id.value) + '&giorno=' + encodeURIComponent(giorno.value) + '&mese=' + encodeURIComponent(mese.value) + '&anno=' + encodeURIComponent(anno.value))
  ...
  function rimuovi(e) {
    ...
    // Invio il token al server
    var xhr = new XMLHttpRequest()
    xhr.open('POST', '/ajax/utente/anagrafiche/rimuoviDataNascita.php', true)
    xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded')
