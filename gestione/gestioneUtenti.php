      ...
      <div id="contenitoreBox">
        <div class="box">
          ...
          <div class="descrizione">
            ...
            <a href="/gestione/ricercaUtenti.php" class="button">Vai a Ricerca utenti</a>
          </div>
        </div>
        <div class="box">
          <div class="titolo">
          ...
          <div class="descrizione">
            <p>Pannello per l'aggiunta di un utente.</p>
            <a class="button disabled">Vai a Aggiungi utente</a>
          </div>
        </div>
        <div class="box">
          <div class="titolo">
          ...
          <div class="descrizione">
            ...
            <a href="/gestione/gestioneCategorieUtenti.php" class="button">Vai a Categorie utenti</a>
          </div>
        </div>
      </div>
    </div>
